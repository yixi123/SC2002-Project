...
public class ProjectView {
  public static void displayAvailableProjects(List<BTOProject> projectList){
    for (int i = 0; i < projectList.size(); i++) {
      System.out.println((i + 1) + ". " + projectList.get(i));
    }
  }

  // public static void displayFilterSettings(FilterSettings filterSettings){
  ...
  public static void displayEnquiry(){}
}
